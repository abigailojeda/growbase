...
<template>
  <h1 class="text-2xl mb-6 font-semibold text-text">{{ t('navigation.overview') }}</h1>
  <section>
    <div class="grid grid-cols-1 gap-8 xl:grid-cols-2">
      ...
      >
        <div class="flex flex-col gap-4">
          <SummaryCard :label="t('summary.totalCrops')" :value="totalCrops" />

          <SummaryCard :label="t('summary.activeCrops')" :value="activeCrops" variant="primary" />
    ...
    <div class="mt-8">
      <TaskStatusOverview
        :title="isAdmin ? t('tasks.tasksOverview') : t('tasks.myTasks')"
        :summary="taskSummary"
        :tasks="tasks"
